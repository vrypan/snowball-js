...
Ported from https://github.com/Apmats/greekstemmerjs
which is a JS port of the greek stemmer made by the skroutz 
team in ruby (which is available over here https://github.com/skroutz/greek_stemmer)

This is a very crude implementation of a Greek stemmer. I just wrapped
@Apmats in a way that will be compatible with the rest of the stemmers.

License: MIT
Author: Panayotis Vryonis, https://vrypan.net/
*/
...
function GreekStemmer() {
  ...
  this.stem = function() {
    ...
    var word = this.current.normalize('NFD').replace(/[\u0300-\u036f]/g, "").toUpperCase() ;

    var stemmedWord = word;

    if (word.length < 3) {
      this.current = stemmedWord ;
      return true ;
    }
